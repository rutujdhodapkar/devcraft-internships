...
const BUILTIN_TEMPLATES = {
  welcome: {
    ...
    build: (v) => wrap(`
      ...
      <div style="text-align:center"><a class="btn" href="${v.domain || 'https://devcraft.rutujdhodapkar.tech'}/dashboard">View Dashboard</a></div>
  ...
  task_assigned: {
    ...
    build: (v) => wrap(`
      ...
      <div style="text-align:center"><a class="btn" href="${v.domain || 'https://devcraft.rutujdhodapkar.tech'}/dashboard">View Task</a></div>
  ...
  task_completed: {
    ...
    build: (v) => wrap(`
      ...
      <div style="text-align:center"><a class="btn" href="${v.domain || 'https://devcraft.rutujdhodapkar.tech'}/dashboard">Track Progress</a></div>
  ...
  task_verified: {
    ...
    build: (v) => wrap(`
      ...
      <div style="text-align:center"><a class="btn" href="${v.domain || 'https://devcraft.rutujdhodapkar.tech'}/dashboard">Continue</a></div>
  ...
  payment_pending: {
    ...
    build: (v) => wrap(`
      ...
      <div style="text-align:center"><a class="btn" href="${v.domain || 'https://devcraft.rutujdhodapkar.tech'}/dashboard">Complete Payment</a></div>
  ...
  payment_failed: {
    ...
    build: (v) => wrap(`
      ...
      <div style="text-align:center"><a class="btn" href="${v.domain || 'https://devcraft.rutujdhodapkar.tech'}/dashboard">Retry Payment</a></div>
  ...
  certificate_ready: {
    ...
    build: (v) => wrap(`
      ...
      <div style="text-align:center"><a class="btn" href="${v.domain || 'https://devcraft.rutujdhodapkar.tech'}/dashboard">Download Certificate</a></div>
  ...
  internship_completed: {
    ...
    build: (v) => wrap(`
      ...
      <div style="text-align:center"><a class="btn" href="${v.domain || 'https://devcraft.rutujdhodapkar.tech'}">Explore More</a></div>
  ...
  internship_expired: {
    ...
    build: (v) => wrap(`
      ...
      <div style="text-align:center"><a class="btn" href="${v.domain || 'https://devcraft.rutujdhodapkar.tech'}/dashboard">View Options</a></div>
  ...
  promo: {
    ...
    build: (v) => wrap(`
      ...
      <div style="text-align:center"><a class="btn" href="${v.domain || 'https://devcraft.rutujdhodapkar.tech'}/domains">Browse Domains</a></div>
  ...
  reminder: {
    ...
    build: (v) => wrap(`
      ...
      <div style="text-align:center"><a class="btn" href="${v.domain || 'https://devcraft.rutujdhodapkar.tech'}/dashboard">View Details</a></div>
  ...
  system_update: {
    ...
    build: (v) => wrap(`
      ...
      <div style="text-align:center"><a class="btn" href="${v.domain || 'https://devcraft.rutujdhodapkar.tech'}/dashboard">View Changes</a></div>
