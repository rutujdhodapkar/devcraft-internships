...
export default function PartnerPortal({ type, title, subtitle, onClose, user }) {
  ...
  const apply = async (event) => {
    ...
    await saveAgency({ ...application, partnerType: type, emails: [email], ownerEmail: email, memberRoles: { [email]: "owner" }, subscriptionPlan: "Starter", subscriptionStatus: "trial", approved: false });
